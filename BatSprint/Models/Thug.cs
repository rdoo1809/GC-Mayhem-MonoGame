/*
* Thug class
* 1/3 enemy types - punches and shoots
 */
...
{
    public class Thug : DrawableGameComponent
    {
        //general props
        ...
        public float travelDuration = 100.0f;
        ...
        public Thug(Game game, SpriteBatch sb, Vector2 pos, Hero hero, bool movingRight, bool movingUp) : base(game)
        {
            this.game = game;
            this.tex = Global.Content.Load<Microsoft.Xna.Framework.Graphics.Texture2D>("images/thugSprite");
        ...
        {
            return new Rectangle((int)position.X, (int)position.Y, tex.Width/6, tex.Height/8);
        }
        ...
        public void punchHero(Hero hero, Thug t)
        {
            Rectangle heroRect = hero.getBounds();
            Rectangle stalkRect = t.getBounds();
            ...
            { //if still intersecting after timer - register hit
                ...
                if (isStillIntersecting && t.stillAlive)
                {
                    hitSound.Play();
                    hero.lives--;
